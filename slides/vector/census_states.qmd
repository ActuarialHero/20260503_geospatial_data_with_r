...
3) Sometimes the borders don't line up well when zoomed out. They look better zooming in
:::
...
leaflet fitBounds(lng1, lat1, lng2, lat2) function Can't handle wrapping around the date line
:::
